								...
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="detail/{{$new->id}}">
											<img src="source\source\image\product\{{$new->image}}" alt="">
										</a>
									</div>
									<div class="single-item-body">
										...
										<p class="single-item-price">
											@if($new->promotion_price==!0)
												<span class="flash-del">${{ number_format($new->unit_price, 2) }}</span>
												<span class="flash-sale">${{ number_format($new->promotion_price, 2) }}</span>
											@else
												<span>${{ number_format($new->unit_price, 2) }}</span>
											@endif
										</p>
									</div>
						...
						<div class="row">
							...
							<div class="col-sm-3">
								<div class="single-item">
									...
									<div class="single-item-header">
										<a href="{{ route('chitietsanpham', ['id' => $km->id]) }}">
											<img src="/source/image/product/{{$km->image}}" alt="">
										</a>
									</div>
									<div class="single-item-body">
										...
										<p class="single-item-price">
											@if($product->promotion_price > 0)
												<span class="flash-del">${{ number_format($km->unit_price, 2) }}</span>
												<span class="flash-sale">${{ number_format($km->promotion_price, 2) }}</span>
											@else
												<span>${{ number_format($km->unit_price, 2) }}</span>
											@endif
										</p>
									</div>
									<div class="single-item-caption">
